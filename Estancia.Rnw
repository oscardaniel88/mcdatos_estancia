...
opts_chunk$set(fig.width=12, fig.height=4, fig.path='figures/',
...
ggplot(pickup_src, aes(antelacion, reservas)) + geom_line() + xlim(-1,25) + facet_wrap(~rsrv_src) + ggtitle("Pickup por Canal de Reserva")
@
