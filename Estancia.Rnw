...
\paragraph{Ocupación} ~\\
<<IndicadoresOcupación, echo=FALSE>>=
ggplot(indicadores, aes(fecha, occ)) + geom_line() +
 xlab("") + ylab("% Ocupacion")+ggtitle("% Ocupacion") + geom_smooth()
@
\paragraph{Tarifa Promedio} ~\\
