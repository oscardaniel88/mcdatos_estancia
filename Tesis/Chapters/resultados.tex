...
El modelo de recomendaciones de precio toma como entrada la demanda pronósticada por el modelo de pronóstico de demanda con mejor desempeño de acuerdo al \emph{MAPE}. A partir de ahi, se define un problema de maximización sujeto a restricciones y se arroja una matriz que contiene los precios para un tipo de cuarto dependiendo del inventario disponible dentro de la propidad.
