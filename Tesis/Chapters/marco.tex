...
Los resultados mostraron que la \emph{regresión de Ridge} una transformación polinomial de grado dos tuvo el mejor desempeño con un \emph{MAPE} del 8.20\% durante la validación y un \emph{MAPE} del 8.65\% durante las pruebas.
...
Los resultados obtenidos durante esta investigación fueron bastante prometedores y sustentaron el uso de modelos de \texttt{M.L.} como modelos de caja negra para estimar la ocupación futura de una propiedad sin requerir conocimiento o experiencia estadística del estaff del hotel, permitiendo nuevos avances en las técnicas de \emph{revenue management} en el sector de hospitalidad.
