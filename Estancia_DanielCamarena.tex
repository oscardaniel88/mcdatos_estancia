...
Es responsabilidad de cada uno de los hoteles el revisar los distintos reportes expuestos en la organización en donde pueden encontrar: sus niveles de ocupación, ocupación de la competencia, tarifas promedio propias, tarifas promedio de la competencia, penetración de ocupación: $\% ocupacion\ propia\ /\ \% ocupacion\ de\ la\ competencia$ y penetración de tarifa: $tarifa\ promedio\ propia\ / tarifa\ promedio\ de\ la\ competencia$ para decidir si deben hacer un incremento o decremento en los precios ofertados.
